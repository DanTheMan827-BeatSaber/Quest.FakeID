...
MAKE_DLOPEN_HOOK_MATCH(PlayerDataFileModel_Load, &GlobalNamespace::PlayerDataFileModel::LoadOrCreateFromJsonString, GlobalNamespace::PlayerData*, GlobalNamespace::PlayerDataFileModel* self, StringW jsonString) {
